...
The modulo operator is indicated by % and gives the remainder of a division 
calculation. If the two numbers are divisible, then the result of the modulo 
operation will be 0.
...
We see that 29 % 5 equals 4, 32 % 3 equals 2, and 44 % 2 equals 0.

Lets look at another example to get a better idea of how modulo is useful in 
programming:
